...
from .ipysnobal import get_timestep_info, initialize, DEFAULT_NORMAL_THRESHOLD
...
def main(configFile):
    ...
    params, tstep_info = get_timestep_info(options['constants'], options)
