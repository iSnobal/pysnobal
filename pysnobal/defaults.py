...
DEFAULT_SNOWPACK = {'snow_depth_cm': 0, 
                    'bulk_snow_density_kgm-3': 0, 
                    'active_layer_temp_degC': 0, 
                    'avg_snow_temp_degC': 0, 
                    'h2o_sat_%': 0}

DEFAULT_PARAMS = {'relative_heights': False,
...
EM_OUT = ['R_n_bar', 'H_bar', 'L_v_E_bar', 'M_bar', 'G_bar', 'G_0_bar', 'delta_Q_bar', 'delta_Q_0_bar']
SNOW_OUT = ['rho', 'T_s', 'T_s_0', 'T_s_l', 'z_s', 'z_s_0', 'z_s_l', 'cc_s', 'cc_s_0', 'cc_s_l', 'm_s', 'm_s_0', 'm_s_l', 'h2o', 'h2o_sat', 'E_s_sum', 'melt_sum', 'ro_pred_sum']

# ***** Mappings from Custom Variable Names to Names Snobal Expects *****

FORCING_NAMES_CUSTOM2SNOBAL = {'net_solar_Wm-2' : 'S_n', 
